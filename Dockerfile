...
COPY --from=builder --chown=node:node /home/node/covers .
COPY --from=builder --chown=node:node /home/node/prisma .
COPY --from=builder --chown=node:node /home/node/public .
...
COPY --from=builder --chown=node:node /home/node/.next .
COPY --from=builder --chown=node:node /home/node/node_modules .
