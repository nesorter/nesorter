...
export const Icon = ({ name, color, size }: { name: IconName, color: string, size: number }): JSX.Element => {
  const Component = map[name];

  return <Box minWidth={size} minHeight={size}><Component color={color} width={size} height={size} /></Box>;
};
